...
from exams.forms import BaseAnswerInlineFormSet, QuestionForm, TakeExamsForm
...
class StudentsExamsListView(ListView):
    ...
    template_name = 'classroom/students/exams_list.html'
        ...
        if form.is_valid():
            with transaction.atomic():
                ...
                if student.get_unanswered_exams(exams).exists():
                    return redirect('exams:take_exams', pk)
                else:
