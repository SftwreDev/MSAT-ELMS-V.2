...
urlpatterns = [
    ...
    path('profile/create-student-profile/', views.StudentProfileCreate.as_view(), name='student-create-profile'),
    ...
    path('profile/student-update-profile/<int:pk>/', views.ProfileUpdateView.as_view(), name='student-update-profile'),
    path('profile/student-profile/<int:pk>/delete/', views.ProfileDeleteView.as_view(), name='student_profile_delete'),
