...
class StudentProfile(models.Model):
    ...
    profile_picture = models.ImageField(verbose_name='Profile Picture', default='profile_picture/default.png', upload_to='profile_picture', blank=True)
    ...
    birthday = models.DateField(auto_now_add=False, verbose_name='Birthday', blank=False)
    ...
    bio = models.TextField(max_length=100, verbose_name='Your Bio', blank=False)
